...
```json
{
  ...
  "getSingleSubscriber" : {
    ...
    "networkInfo" : {
      "subscriberid" : 21046,
      "time" : "2025-07-13T09:45:29.085375",
      "lastMcc" : 222,
      "lastMnc" : 99,
      "lastCellId" : 123456,
      "lastLac" : 456,
...
```json
{
  ...
  "resetSubsGzCounter" : {
    "subscriberId" : 4,
    "volumeOnGZ" : 123456,
    "lastResetDate" : "2025-07-13T07:45:29.088767",
    "lastUpdateDate" : "2025-07-12T20:39:29.088776"
  }
}
```
### 2.16.2 By IMSI
...
```json
{
  ...
  "subscriberLocation" : {
    ...
    "longitude" : 8.55877,
    "accuracy" : 250,
    "dateTime" : "2025-07-12T09:45:29.088801"
  }
}
```
### 2.17.2 By IMSI
...
|cellId|Mandatory|The tower cell Id.|
...
```json
{
  "affectPackageToSubscriber" : {
    ...
    "activePeriod" : {
      "start" : "2025-07-13T09:45:29.089753",
      "end" : "2025-08-12T09:45:29.089759"
    }
  }
}
```
...
```json
{
  "affectRecurringPackageToSubscriber" : {
    ...
    "startTimeUTC" : "2025-07-13T07:45:29",
...
```json
{
  "modifySubscriberPrepaidPackageExpDate" : {
    "packageId" : 123,
    "newPeriod" : 45,
    "newDateUtc" : "2025-07-13T09:45:29"
  }
}
```
### Answer
