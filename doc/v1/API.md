...
```json
{
  ...
  "getSingleSubscriber" : {
    ...
    "networkInfo" : {
      "subscriberid" : 21046,
      "time" : "2025-11-13T11:28:46.665031",
      "lastMcc" : 222,
      "lastMnc" : 99,
      "lastCellId" : 123456,
      "lastLac" : 456,
...
```json
{
  ...
  "resetSubsGzCounter" : {
    "subscriberId" : 4,
    "volumeOnGZ" : 123456,
    "lastResetDate" : "2025-11-13T10:28:46.669065",
    "lastUpdateDate" : "2025-11-12T23:22:46.669081"
  }
}
```
### 2.16.2 By IMSI
...
```json
{
  ...
  "subscriberLocation" : {
    ...
    "longitude" : 8.55877,
    "accuracy" : 250,
    "dateTime" : "2025-11-12T11:28:46.669101"
  }
}
```
### 2.17.2 By IMSI
...
```json
{
  "affectPackageToSubscriber" : {
    ...
    "activePeriod" : {
      "start" : "2025-11-13T11:28:46.670084",
      "end" : "2025-12-13T11:28:46.67009"
    }
  }
}
```
...
```json
{
  "affectRecurringPackageToSubscriber" : {
    ...
    "startTimeUTC" : "2025-11-13T10:28:46",
...
```json
{
  "modifySubscriberPrepaidPackageExpDate" : {
    "packageId" : 123,
    "newPeriod" : 45,
    "newDateUtc" : "2025-11-13T11:28:46"
  }
}
```
### Answer
