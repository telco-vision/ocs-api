...
```json
{
  ...
  "getSingleSubscriber" : {
    ...
    "networkInfo" : {
      "subscriberid" : 21046,
      "time" : "2024-09-01T11:52:31.853926",
      "lastMcc" : 222,
      "lastMnc" : 99,
      "lastCellId" : 123456,
      "lastLac" : 456,
...
```json
{
  "affectPackageToSubscriber" : {
    ...
    "activePeriod" : {
      "start" : "2024-09-01T11:52:31.857616",
      "end" : "2024-10-01T11:52:31.857625"
    }
  }
}
```
...
```json
{
  "affectRecurringPackageToSubscriber" : {
    ...
    "startTimeUTC" : "2024-09-01T09:52:31"
  }
}
```
#### Answer
...
```json
{
  "modifySubscriberPrepaidPackageExpDate" : {
    "packageId" : 123,
    "newPeriod" : 45,
    "newDateUtc" : "2024-09-01T11:52:31"
  }
}
```
### Answer
