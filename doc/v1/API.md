...
```json
{
  ...
  "getSingleSubscriber" : {
    ...
    "networkInfo" : {
      "subscriberid" : 21046,
      "time" : "2025-07-16T11:56:09.598477",
      "lastMcc" : 222,
      "lastMnc" : 99,
      "lastCellId" : 123456,
      "lastLac" : 456,
...
```json
{
  ...
  "resetSubsGzCounter" : {
    "subscriberId" : 4,
    "volumeOnGZ" : 123456,
    "lastResetDate" : "2025-07-16T09:56:09.603086",
    "lastUpdateDate" : "2025-07-15T22:50:09.603096"
  }
}
```
### 2.16.2 By IMSI
...
```json
{
  ...
  "subscriberLocation" : {
    ...
    "longitude" : 8.55877,
    "accuracy" : 250,
    "dateTime" : "2025-07-15T11:56:09.603121"
  }
}
```
### 2.17.2 By IMSI
...
```json
{
  "affectPackageToSubscriber" : {
    ...
    "activePeriod" : {
      "start" : "2025-07-16T11:56:09.604176",
      "end" : "2025-08-15T11:56:09.604183"
    }
  }
}
```
...
```json
{
  "affectRecurringPackageToSubscriber" : {
    ...
    "startTimeUTC" : "2025-07-16T09:56:09",
...
```json
{
  "modifySubscriberPrepaidPackageExpDate" : {
    "packageId" : 123,
    "newPeriod" : 45,
    "newDateUtc" : "2025-07-16T11:56:09"
  }
}
```
### Answer
