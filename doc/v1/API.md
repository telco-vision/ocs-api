...
```json
{
  ...
  "getSingleSubscriber" : {
    ...
    "networkInfo" : {
      "subscriberid" : 21046,
      "time" : "2025-08-20T08:30:41.446819",
      "lastMcc" : 222,
      "lastMnc" : 99,
      "lastCellId" : 123456,
      "lastLac" : 456,
...
```json
{
  ...
  "resetSubsGzCounter" : {
    "subscriberId" : 4,
    "volumeOnGZ" : 123456,
    "lastResetDate" : "2025-08-20T06:30:41.450211",
    "lastUpdateDate" : "2025-08-19T19:24:41.45022"
  }
}
```
### 2.16.2 By IMSI
...
```json
{
  ...
  "subscriberLocation" : {
    ...
    "longitude" : 8.55877,
    "accuracy" : 250,
    "dateTime" : "2025-08-19T08:30:41.450238"
  }
}
```
### 2.17.2 By IMSI
...
```json
{
  "affectPackageToSubscriber" : {
    ...
    "activePeriod" : {
      "start" : "2025-08-20T08:30:41.451171",
      "end" : "2025-09-19T08:30:41.451177"
    }
  }
}
```
...
```json
{
  "affectRecurringPackageToSubscriber" : {
    ...
    "startTimeUTC" : "2025-08-20T06:30:41",
...
```json
{
  "modifySubscriberPrepaidPackageExpDate" : {
    "packageId" : 123,
    "newPeriod" : 45,
    "newDateUtc" : "2025-08-20T08:30:41"
  }
}
```
### Answer
