...
```json
{
  ...
  "getSingleSubscriber" : {
    ...
    "networkInfo" : {
      "subscriberid" : 21046,
      "time" : "2024-07-17T14:01:39.926882",
      "lastMcc" : 222,
      "lastMnc" : 99,
      "lastCellId" : 123456,
      "lastLac" : 456,
...
```json
{
  "affectPackageToSubscriber" : {
    ...
    "activePeriod" : {
      "start" : "2024-07-17T14:01:39.930776",
      "end" : "2024-08-16T14:01:39.930791"
    }
  }
}
```
...
```json
{
  "affectRecurringPackageToSubscriber" : {
    ...
    "startTimeUTC" : "2024-07-17T12:01:39"
  }
}
```
#### Answer
...
```json
{
  "modifySubscriberPrepaidPackageExpDate" : {
    "packageId" : 123,
    "newPeriod" : 45,
    "newDateUtc" : "2024-07-17T14:01:39"
  }
}
```
### Answer
