...
```json
{
  ...
  "getSingleSubscriber" : {
    ...
    "networkInfo" : {
      "subscriberid" : 21046,
      "time" : "2026-04-15T17:41:26.612838",
      "lastMcc" : 222,
      "lastMnc" : 99,
      "lastCellId" : 123456,
      "lastLac" : 456,
...
```json
{
  ...
  "subscriberLocation" : {
    ...
    "longitude" : 8.55877,
    "accuracy" : 250,
    "dateTime" : "2026-04-14T17:41:26.616646"
  }
}
```
### 2.17.2 By IMSI
...
```json
{
  "affectPackageToSubscriber" : {
    ...
    "activePeriod" : {
      "start" : "2026-04-15T17:41:26.618101",
      "end" : "2026-05-15T17:41:26.618113"
    }
  }
}
```
...
```json
{
  "affectRecurringPackageToSubscriber" : {
    ...
    "startTimeUTC" : "2026-04-15T15:41:26",
...
- `parentResellerCost` will be only visible if you are a parent reseller
...
```json
{
  "modifySubscriberPrepaidPackageExpDate" : {
    "packageId" : 123,
    "newExpirationDate" : "2026-05-15T17:41:26"
  }
}
```
#### Answer
...
```json
{
  "modifySubscriberPrepaidPackageActivePeriod" : {
    "packageId" : 123,
    "newActivationDateUtc" : "2026-04-15T17:41:26",
    "newExpirationDateUtc" : "2026-04-25T17:41:26",
